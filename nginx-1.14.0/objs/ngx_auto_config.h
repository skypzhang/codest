#define NGX_CONFIGURE " --user=nginx --group=nginx --prefix=/opt/nginx/ --with-stream --with-http_ssl_module --with-http_stub_status_module --without-http_autoindex_module --without-http_ssi_module"
